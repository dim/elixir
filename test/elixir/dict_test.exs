  ...
  defmacro __using__(module, _opts // []), do:
    quote do:
      ...
      test :merge_with_function, do:
        ...
        result = Dict.merge dict1, dict2, &> (_k, v1, v2)
          v1 + v2
        end
      ...
      test :update, do:
        dict = Dict.update new_dict, "first_key", &> (val) -val end
        assert -1 == Dict.get dict, "first_key"

        dict = Dict.update dict, "non-existent", "...", &> (val) -val end
