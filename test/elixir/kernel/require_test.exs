...
defmodule Kernel.RequireTest do
  ...
  deftest :locals_are_always_required do
    assert __MODULE__.my_macro == 2
  end

  deftest :locals_and_private_are_always_required do
    assert my_private_macro == 4
  end

  deftest :locals_with_default_are_always_required do
    assert my_macro_with_default == 6
  end

  deftest :cannot_be_called_dynamically_even_if_required do
    x = Nested
