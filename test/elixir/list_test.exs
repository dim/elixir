...
defmodule ListTest, do:
  ...
  test :foldl, do:
    assert List.foldl([1,2,3], 0, => (x,y) x + y end) == 6
    assert List.foldl([1,2,3], 10, => (x,y) x + y end) == 16
    assert List.foldl([1,2,3,4], 0, => (x,y) x - y end) == 2
  end

  test :foldr, do:
    assert List.foldr([1,2,3], 0, => (x,y) x + y end) == 6
    assert List.foldr([1,2,3], 10, => (x,y) x + y end) == 16
    assert List.foldr([1,2,3,4], 0, => (x,y) x - y end) == -2
  end
  ...
  test :sort, do:
    ...
    assert ['0', '2', '3', '10', '11'] == List.sort ['2', '3', '0', '11', '10'], => (a, b)
